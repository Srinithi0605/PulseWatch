...
import { fmtInr, fmtVolume } from "@/lib/market/engine";
  ...
  head: ({ params }) => {
    ...
    return {
      meta: [
        ...
        {
          name: "description",
          content: `${symbol} live quote, attention score, volume ratio, NIFTY-relative performance and price history on PulseWatch.`,
        },
